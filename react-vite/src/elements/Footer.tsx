...
export default function Footer({}){
    ...
    return <>
    <section style={{minHeight: '45px', background: 'rgb(0, 0, 0)'}} className="p-16 text-extralight">
        <div className="flex justify-between flex-wrap gap-8 mx-20">
            ...
            <div className="flex flex-col items-center md:items-start gap-2 text-zinc-800 text-sm" style={{width: '216px', lineHeight: '19px'}}>
